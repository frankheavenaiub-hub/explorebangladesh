...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if ($flag) {
        ...
        // Clear the stored session data so the form resets
        $_SESSION['packagename'] = "";
        $_SESSION['price'] = "";
        $_SESSION['duration'] = "";
        $_SESSION['itinerary'] = "";
        
        // Success: Instantly redirect back to the dashboard table
        header("Location: ../View/sales-package.php");
        exit();
        
    } else {
        // Failure: Instantly redirect back to the form to show the validation errors
