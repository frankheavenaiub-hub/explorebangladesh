...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    // FIX 1: Safely capture the hidden ID to verify if this is an Edit or an Add
    ...
    // FIX 2: If it's an Update, bypass the image requirement. 
    // It will only force an image upload if you are ADDING a new package.
