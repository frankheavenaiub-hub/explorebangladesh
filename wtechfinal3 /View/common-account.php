...
<body>
            ...
            <div class="profile-card">
                ...
                <form id="profileForm" action="../Controller/common-account-php-validation.php" method="POST">
                    ...
                    <div class="button-group">
                        ...
                        <!-- FIX: Changed to type="button" and added onclick to bypass form validation -->
    ...
    <!-- FIX: Trigger JS alert if update was successful -->
    <?php if (isset($_SESSION['updateSuccess'])): ?>
        <script>
            alert("<?php echo $_SESSION['updateSuccess']; ?>");
        </script>
        <?php unset($_SESSION['updateSuccess']); // Clear the message so it doesn't pop up again ?>
    <?php endif; ?>
