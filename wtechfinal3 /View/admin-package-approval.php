...
require_once '../Model/booking.php'; // Or package.php, wherever you placed the functions
...
<head>
    ...
    <link rel="stylesheet" href="admin-user-management.css"> <!-- Reusing your table styles -->
</head>
<body>
                            ...
                            <?php foreach ($pendingPackages as $p): ?>
                                <tr>
                                    ...
                                    <td class="action-links" style="display: flex; gap: 10px;">
                                        <!-- Reusing your green/red button classes -->
