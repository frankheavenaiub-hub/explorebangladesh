            ...
            <div class="existing-packages">
                ...
                <table>
                    <tr>
                        ...
                        <th>Price (BDT)</th>
                        <th>Duration</th>
                        <th>Approval Status</th> <!-- Updated Header -->
                        <th>Action</th>
                    </tr>
                    <?php
                    $conn = connect();
                    // Updated SQL to select approval_status instead of availability
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            // Display the Approval Status (Pending, Approved, or Rejected)
