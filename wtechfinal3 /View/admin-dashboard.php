...
require_once '../Model/user.php';     // To get total users
require_once '../Model/booking.php';  // To get bookings, revenue, and packages
            ...
            <div class="analytics">
                ...
                <div class="analytics-boxes">
                    ...
                    <div class="analytics-box">
                        ...
                        <!-- These rely on the getStatusCount function already in your booking.php -->
