...
// Get all bookings for a specific customer (username)
...
// Cancel a booking (only if it belongs to this customer and is still Pending)
...
// Get all available packages (for the customer to browse/book)
