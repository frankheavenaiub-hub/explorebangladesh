...
require_once '../Model/dbConnect.php'; // Ensure your functions (like getAllAvailablePackages) are accessible here
$packages = getAllAvailablePackages();

// Read any session messages
...
// 1. Capture Filter & Sort GET variables
...
// 2. Apply Filters (Search and Duration Range)
...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <!-- Updated Form with Duration Filters and Sorting -->
                ...
                <?php foreach ($packages as $pkg): ?>
                    ...
                    <div class="package-box">
                        ...
                        <div class="info">
                            ...
                            <!-- Simple inline booking form for this package -->
